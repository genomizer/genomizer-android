...
public class ResultFragment extends Fragment {
	...
	private ArrayList<GeneFile> result;
	private ArrayList<GeneFile> selectedResult;
	

	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		result = DataStorage.getFileList("result");
		selectedResult = new ArrayList<GeneFile>();
	}


	public View onCreateView(LayoutInflater inflater, ViewGroup parent,
			Bundle savedInstanceState) {
		View v = inflater.inflate(R.layout.fragment_result, parent, false);

		listResult = (ListView) v.findViewById(R.id.result);
		listResult.setAdapter(new FileListAdapter(result, "raw"));
...
//		});
	...
	private void appendSelectedFile(GeneFile file) {
		selectedResult.add(file);
	}
	
	
	private void removeSelectedFile(GeneFile file) {
		selectedResult.remove(file);
	}
